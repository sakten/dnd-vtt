...
> **Очередь:** R7.5–R7.7, R7.10, R9.1–R9.4, R10 (карточки ниже — единственный источник деталей).
> **Сделано (в истории git):** R6.1–R6.9, R7.1–R7.4, R7.8, R7.9, R8.1–R8.8 (фундамент черт + лог партий 1–22), R8.6 (метки бросков) — `git log -p -- REFACTOR.md`.
