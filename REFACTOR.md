...
> **Очередь:** R7.3, R7.5–R7.10, R8.6, R9.1–R9.4 (карточки ниже — единственный источник деталей).
> **Сделано (в истории git):** R6.1–R6.9, R7.1, R7.2, R7.4, R8.1–R8.5, R8.7, R8.8 (фундамент черт + лог партий 1–22) — `git log -p -- REFACTOR.md`.
