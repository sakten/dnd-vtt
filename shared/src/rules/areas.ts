...
/**
 * Клетки области, достижимые от вершины: заливка по 8 соседям (диагональный шаг
 * нужен для диагональных конусов/линий), переход между клетками запрещён, если их
 * центры разделяет блокирующая стена (закрытая дверь) — касание угла тоже блокирует.
