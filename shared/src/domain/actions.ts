...
export interface MonsterAbilityDef {
  ...
  /** Автосрабатывание: при полученном уроне или при смерти (HP до 0); пусто — обычная способность. */
  trigger?: 'takeDamage' | 'death';
  /** Радиус авто-целей триггерной способности, футы (по умолчанию 5). */
  radius?: number;
  /** Сторона авто-целей: все (по умолчанию) / враги / союзники. */
  side?: 'any' | 'hostile' | 'ally';
}
