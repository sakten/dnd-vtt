...
// Формы (С5): витрина зверя через резолвер, отдельный пул HP, возврат по урону,
// синхронизация подошвы (отечественная 1×1 ↔ 2×2) без потери своих полей.
...
// Урон по пулу: обнуление — возврат, свои поля витрины на месте.
