...
const DEFAULT_CHAT_SAVE_DEBOUNCE_MS = 5000;
...
/** Дебаунс записи комнаты (мс), env `VTT_SAVE_DEBOUNCE_MS`, по умолчанию 5 с. */
export const SAVE_DEBOUNCE_MS = readPositiveNumber(process.env.VTT_SAVE_DEBOUNCE_MS, DEFAULT_SAVE_DEBOUNCE_MS);
/** Дебаунс записи чата (мс), env `VTT_CHAT_SAVE_DEBOUNCE_MS`, по умолчанию 5 с (только при изменении). */
